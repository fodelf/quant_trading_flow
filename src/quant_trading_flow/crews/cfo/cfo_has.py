...
class CfoHasCrew:
    ...
    agents_config = "config/agents_has.yaml"
    tasks_config = "config/tasks_has.yaml"

    # If you would lik to add tools to your crew, you can learn more about it here:
    # https://docs.crewai.com/concepts/agents#agent-tools
    @agent
    def cfo_has(self) -> Agent:
        return Agent(
            config=self.agents_config["cfo_has"],  # type: ignore[index]
            llm=deepseek_llm,
            max_retry_limit=10,
