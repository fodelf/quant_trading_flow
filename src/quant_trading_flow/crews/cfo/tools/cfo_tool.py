...
@tool("获取风险数据报告工具")
def get_risk_report(symbol: str, file_date: str) -> str:
    """
    获取股票{symbol}风险数据报告
    ...
    Returns:
        str: 返回风险数据报告字符串
    """
    with open(f"output/{symbol}/{file_date}/risk_management.md", "r") as f:
        risk_management = f.read()
